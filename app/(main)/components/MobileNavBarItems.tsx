...
function MobileNavBarItems({ label, icon: Icon, href, active }: Props) {
    return (
        <li className="relative">
            ...
            <Link href={href} className={clsx(`relative group flex flex-col gap-x-2 items-center p-2 px-4 hover:bg-white/20 hover:text-white text-black -mx-1`, active && 'bg-white/20 text-white')}>
