...
function ListSkeleton() {
    return (
        <div className="flex h-full w-full bg-[#f9f9f9] rounded-2xl">
                    ...
                    <ul className="px-1">
                        {
                            new Array(4).fill(0).map((_, index) => {
                                return (
                                    <li key={index} className='w-96 flex items-center justify-between px-2 rounded-[5px] my-1 py-2 gap-1.5 animate-pulse'>
            ...
            <div className="w-full flex items-center justify-center dark:bg-background rounded-r-2xl gap-2">
